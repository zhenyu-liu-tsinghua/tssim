...
do
    ...
    then
        ...
        #do
            ...
            echo "arguments       =  --preset medium --pass 1 --input ${sequence_dir}/${sequence_name} --input-res ${width}x${height} --fps ${framerate} --ref 4 --bitrate ${rate} --ssim --tune ssim --qg-size 32 --aq-mode 1 --aq-strength 1.0 --b-adapt 1 --bframes 15 --max-tlayer 4 --keyint 5000 --frame-thread 1 --no-wpp --no-pmode --no-pme --slices 0 --lookahead-slices 0 --pools none -o output.265 --csv ${seq}_${rate}.csv" >> ${sub_file}
